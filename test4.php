    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            ...
            <div>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="lifting_frequency_2" value="si" required>
                    <label class="form-check-label">Sì</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="lifting_frequency_2" value="no" required>
                    <label class="form-check-label">No</label>
                </div>
            </div>
            <div>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="lifting_frequency_3" value="si" required>
                    <label class="form-check-label">Sì</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="lifting_frequency_3" value="no" required>
                    <label class="form-check-label">No</label>
                </div>
            </div>
        </div>
