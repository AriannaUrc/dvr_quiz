...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['question1'])) {
    ...
    $query = "INSERT INTO `questions` (`ID`, `qsn`, `username`, `num_domanda`) VALUES (NULL, '$response', '$name', 'pre3')";

    if ($conn->query($query) === TRUE) {
        // Check response and redirect accordingly
        if ($response === 'Yes') {
            // Create a form to submit to generate_pdf.php
            ...
            // Create a form to submit to test.php with the name parameter
...
<div class="container mt-4">
    ...
    <form method="post">
        <div class="form-group">
            <label for="question1">Possibilità di evitare la movimentazione manuale dei carichi con attrezzature meccaniche o ausili?</label>
            <div>
